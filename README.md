...
# ubuntu-iso-builder-remix-hyprland
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-hyprland](https://samwhelp.github.io/ubuntu-iso-builder-remix-hyprland/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-hyprland](https://samwhelp.github.io/ubuntu-iso-builder-respin-hyprland/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-hyprland](https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-hyprland.git
```


> change dir to `ubuntu-iso-builder-remix-hyprland`

``` sh
cd ubuntu-iso-builder-remix-hyprland
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-hyprland/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-hyprland/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-hyprland/iso-profile/dist`
